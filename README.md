[![Build and Test](https://github.com/Gasouu/music-discovery-app/actions/workflows/build-and-test.yml/badge.svg?branch=develop)](https://github.com/Gasouu/music-discovery-app/actions/workflows/build-and-test.yml)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=Gasouu_music-discovery-app&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=Gasouu_music-discovery-app)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=Gasouu_music-discovery-app&metric=coverage)](https://sonarcloud.io/summary/new_code?id=Gasouu_music-discovery-app)
